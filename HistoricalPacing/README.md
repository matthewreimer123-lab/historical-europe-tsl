...
|---|---:|---|
| Research | 225% of vanilla cost | Much longer technological eras |
| Social policies | 125% of vanilla cost | Slower cultural progression |
| Military and civilian units | 75% of vanilla cost | Time to field era-appropriate armies |
| Settlers | about 45% of vanilla cost | Much earlier territorial settlement |
| Buildings | 75% of vanilla cost | Cities can complete their infrastructure |
...
and unit upgrade paths are unchanged in this first test build.

## Installation

Copy the entire `HistoricalPacing` folder into:
